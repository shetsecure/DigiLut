...
class Config(MyConfig):
    def __init__(self):
        ...
        self.train.finetune_path='/home/lipade/damo-yolo/damoyolo_tinynasL20_T_436.pth'

        # augment
        self.train.augment.transform.image_max_range = (1280, 1280)
        ...
        self.dataset.class_names = ['lesion']
